...
TC-003 ตรวจสอบการแจ้งเตือนหลังอัปเดตสถานะ
    ...
    Wait Until Page Contains    Report ของคุณได้รับการดำเนินการแล้ว    10s
    Wait Until Page Contains    รายงานเหตุการณ์ของคุณได้รับการตรวจสอบและดำเนินการโดยผู้ดูแลระบบเรียบร้อยแล้ว    10s
        Capture Page Screenshot 
    sleep   10s