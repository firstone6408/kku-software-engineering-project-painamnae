...
*** Test Cases ***
TC-EMG-16 Stop Notifying Location (2 Emergency Contacts)
    [Documentation]    Test Scenario: UAT-PBI-014-007 - ผู้โดยสารหยุดแจ้งตำแหน่ง กรณีเลือกผู้ติดต่อ 2 คน
    Step 1: Open Website
    Step 2: Login to System
    Step 3.2: Setup Pre-requisite - Start Notifying 2 Contacts
...
Step 3.2: Setup Pre-requisite - Start Notifying 2 Contacts
    ...
    # เลือก 2 คน
    Click Element    xpath=//p[text()='${CONTACT_2_1}']/ancestor::label
    Click Element    xpath=//p[text()='${CONTACT_2_2}']/ancestor::label
