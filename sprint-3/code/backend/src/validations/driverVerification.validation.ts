import { z } from 'zod';
import { VerificationStatus, LicenseType } from '@prisma/client';

export const createDriverVerificationSchema = z.object({
...
export const createDriverVerificationByAdminSchema = z.object({
...
export const updateDriverVerificationSchema = createDriverVerificationSchema.partial();
...
export const listDriverVerifsQuerySchema = z.object({
...
export const updateDriverVerificationByAdminSchema = createDriverVerificationByAdminSchema
  .partial()
  .extend({
...
export type CreateDriverVerificationInput = z.infer<typeof createDriverVerificationSchema>;
