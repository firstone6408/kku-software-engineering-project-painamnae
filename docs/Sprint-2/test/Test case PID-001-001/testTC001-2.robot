...
${DETAIL}     ผู้โดยสารทำร้ายร่างกาย เกิดอาการบาดเจ็บที่แขนซ้าย ก่อให้เกิดอุบัติเหตุรถพลิกคว่ำ
...
TC-001 Report Incident Multiple Problems
    ...
    Click Element    xpath=//label[contains(.,'ผู้โดยสารพูดจาไม่เพราะ')]
    Click Element    xpath=//label[contains(.,'เกิดความเสียหายกับรถ')]
        Capture Page Screenshot
...
TC-002 Report Incident Other Problem With Detail
    ...
    # 9 ตรวจสอบและกรอกรายละเอียด
    Wait Until Page Contains    ระบุรายละเอียดเพิ่มเติม    10s
    Capture Page Screenshot
