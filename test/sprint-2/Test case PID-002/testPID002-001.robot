...
TC-005 อัปเดตสถานะ และแสดงผลลัพธ์
    ...
    Select From List By Label        xpath=//select    แก้ไขแล้ว
        Capture Page Screenshot
    ...
    Wait Until Page Contains    เปลี่ยนสถานะเป็นแก้ไขแล้ว และส่งแจ้งเตือนผู้แจ้งเรียบร้อย    10s
    Wait Until Page Contains    ดำเนินการเสร็จสิ้นแล้ว    10s
